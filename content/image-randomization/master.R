...
rel_path <- "content/image-randomization/"
...
trans_df <- tibble(source_loc = c("code/mgk_image_modulate.R",
                                  "code/mgk_image_median.R",
                                  "code/mgk_image_colorize.R",
                                  "code/mgk_image_quantize.R",
                                  "code/skc_sketch.R")) %>% 
...
source(paste0(rel_path,"code/init_get_list_of_images.R"))

# Choose on image at random
source(paste0(rel_path,"code/init_get_random_image.R"))

# Create function to check that image remains color (as stored) throughout
# the process.
source(paste0(rel_path,"code/check_for_color.R"))
